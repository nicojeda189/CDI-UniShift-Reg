## Clock Signals
## We are using the 100MHz clock and renaming it 'clk_board' to match our Verilog
set_property -dict { PACKAGE_PIN R2    IOSTANDARD SSTL135 } [get_ports { clk_board }]; #IO_L12P_T1_MRCC_34 Sch=ddr3_clk[200]
create_clock -add -name sys_clk_pin -period 10.000 -waveform {0 5.000}  [get_ports { clk_board }];

## Switches
## These are already named sw[0] to sw[3], matching perfectly!
...
## LEDs
## These are the standard green LEDs, named led[0] to led[3]
